...
if __name__ == '__main__':
    ...
    data_generator = RcDataReader(
        wordemb_dict_path='information-extraction/dict/word_idx',
        postag_dict_path='information-extraction/dict/postag_dict',
        label_dict_path='information-extraction/dict/p_eng',
        train_data_list_path='information-extraction/data/train_data.json',
        test_data_list_path='information-extraction/data/dev_data.json')
