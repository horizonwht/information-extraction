...
from bin.p_classification import p_data_reader
...
def p_infer_main(conf_dict, model_path, predict_data_path,
...
if __name__ == '__main__':
    ...
    p_infer_main(conf_dict, model_path, predict_data_path, predict_result_path)
