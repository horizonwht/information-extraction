...
from bin.so_labeling import spo_data_reader
...
def output(text_spo_dic, result_writer):
    ...
    """
    schema_dic = {}
    schema_dic = get_schemas('information-extraction/data/all_50_schemas')
...
def spo_main(conf_dict, model_path, predict_data_path, predict_result_path, \
             use_cuda=False):
...
if __name__ == '__main__':
    ...
    spo_main(conf_dict, model_path, predict_data_path, predict_result_path)
